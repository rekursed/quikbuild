...
use Zeteq\UserBundle\Form\RoleType;
...
class RoleController extends Controller
{
    public function indexAction() {
        ...
        $source = new Entity('ZeteqUserBundle:Role');
        $grid = $this->get('grid');
        ...
        $rowActionDelete = new RowAction('delete', 'role_delete', true);
        $rowAction = new RowAction('edit', 'role_edit');
        ...
        $callback = 'ZeteqUserBundle\RoleController::delete';
        ...
        return $grid->getGridResponse('ZeteqUserBundle:Role:indexapy.html.twig');
    }
    ...
    public function index1Action()
    {
        ...
        $entities = $em->getRepository('ZeteqUserBundle:Role')->findAll();

        return $this->render('ZeteqUserBundle:Role:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ZeteqUserBundle:Role:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ZeteqUserBundle:Role')->find($id);
        ...
        return $this->render('ZeteqUserBundle:Role:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ZeteqUserBundle:Role:edit.html.twig', array(
            'entity'      => $entity,
